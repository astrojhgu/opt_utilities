...
namespace opt_utilities
{
    ...
    class freeze_param : public param_modifier<Tdata, Tp, Tstr>
    {
      public:
      ...
      private:
        ...
        {
            param_num.clear ();
            for (typename std::set<Tstr>::const_iterator i = param_names.begin (); i != param_names.end (); ++i)
                {
                    try
                        {
