...
namespace opt_utilities
{
    ...
    ///////////////////////////////////
    template <typename Tdata, typename Tp, typename Ts, typename Tstr> class statistic;

    template <typename Tdata, typename Tp, typename Tstr> class param_modifier;
     ...
     */
    template <typename _Ty, typename _Tx> class data
    {
      public:
        typedef _Ty Ty;
        typedef _Tx Tx;
      ...
      public:
        /**
           default construct
         */
        data () : x (), x_lower_err (), x_upper_err (), y (), y_lower_err (), y_upper_err ()
        {
        }
    ...
    /**
       ...
       \tparam Tx type of x
     */
    template <typename Tdata> class data_set
    {
      public:
     ...
     */
    template <typename Tp, typename Tstr = std::string> class param_info
    {
      private:
        Tstr name;
        // bool frozen;
      ...
      public:
        ...
        param_info ()
        : name (), value (),
          lower_limit (-std::numeric_limits<typename element_type_trait<Tp>::element_type>::max ()),
         ...
         */
        param_info (const param_info &rhs) : name (rhs.name), description (rhs.description)
        {
        ...
        param_info (const Tstr &_name,
                    ...
                    const typename element_type_trait<Tp>::element_type &_l =
                    -std::numeric_limits<typename element_type_trait<Tp>::element_type>::max (),
                    const typename element_type_trait<Tp>::element_type &_u =
                    std::numeric_limits<typename element_type_trait<Tp>::element_type>::max (),
                    const Tstr &desc = Tstr ())
        : name (_name), value (_v), lower_limit (_l), upper_limit (_u), description (desc)
        {
        }
     ...
     */
    template <typename Tdata, typename Tp, typename Tstr = std::string> class model
    {
      public:
        typedef typename Tdata::Ty Ty;
        typedef typename Tdata::Tx Tx;
      ...
      public:
         ...
         */
        model () : p_param_modifier (NULL_PTR)
        {
        }
        ...
        /**
           copy construct
         */
        model (const model &rhs) : p_param_modifier (NULL_PTR)
        {
      ...
      public:
        ...
        */
        void set_param_value (const Tstr &pname, const typename element_type_trait<Tp>::element_type &v)
        {
            // int porder=0;
            for (typename std::vector<param_info<Tp, Tstr>>::iterator i = param_info_list.begin ();
                 i != param_info_list.end (); ++i)
         ...
         */
        void set_param_lower_limit (const Tstr &pname, const typename element_type_trait<Tp>::element_type &v)
        {
            // int porder=0;
            for (typename std::vector<param_info<Tp, Tstr>>::iterator i = param_info_list.begin ();
                 i != param_info_list.end (); ++i)
        ...
        */
        void set_param_upper_limit (const Tstr &pname, const typename element_type_trait<Tp>::element_type &v)
        {
            // int porder=0;
            for (typename std::vector<param_info<Tp, Tstr>>::iterator i = param_info_list.begin ();
                 i != param_info_list.end (); ++i)
     ...
     */
    template <typename Tdata, typename Tp, typename Ts, typename Tstr = std::string> class fitter
    {
      public:
        typedef typename Tdata::Ty Ty;
        typedef typename Tdata::Tx Tx;
      ...
      public:
        /**
           default construct function
        */
        fitter () : p_model (NULL_PTR), p_statistic (NULL_PTR), p_data_set (NULL_PTR), optengine ()
        {
        }
    ...
    */
    ...
    class statistic : public func_obj<Ts, Tp>
    {
      public:
        typedef typename Tdata::Ty Ty;
        typedef typename Tdata::Tx Tx;
      ...
      public:
        ...
        */
        ...
        : func_obj<Ts, Tp> (static_cast<const func_obj<Ts, Tp> &> (rhs)), p_fitter (rhs.p_fitter)
        {
        }
    ...
    /**
       ...
       \tparam Tstr the type of string used
    */
    template <typename Tdata, typename Tp, typename Tstr = std::string> class param_modifier
    {
      private:
        model<Tdata, Tp, Tstr> *p_model;
      ...
      public:
         ...
         */
        param_modifier () : p_model (NULL_PTR)
        {
        }
        ...
        /**
           copy construct function
         */
        param_modifier (const param_modifier &rhs) : p_model (rhs.p_model)
        {
        }
