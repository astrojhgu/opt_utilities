...
#define NULL_PTR 0
    ...
    /////////Forward declare///////////////////////////////////
    template <typename rT, typename pT> class optimizer;

    template <typename rT, typename pT> class func_obj;

    template <typename rT, typename pT> class opt_method;
     ...
     */
    template <typename rT, typename pT> class func_obj : public std::unary_function<pT, rT>
    {
      private:
        /**
    ...
    */
    template <typename rT, typename pT> class optimizer
    {
      ...
      public:
         ...
         */
        optimizer () : p_opt_method (NULL_PTR), p_func_obj (NULL_PTR)
        {
        }
         ...
         */
        optimizer (const optimizer &rhs) : p_opt_method (NULL_PTR), p_func_obj (NULL_PTR)
        {
